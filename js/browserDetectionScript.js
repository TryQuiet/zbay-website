...
const setAttributes = (version) => {
  ...
  var links = {
    windows: 'https://s3.amazonaws.com/release.zbay.app/Zbay+Setup+1.0.63-dev-windows-2.exe',
    linux: 'https://s3.amazonaws.com/release.zbay.app/Zbay-1.0.63-dev-linux-18-2.AppImage',
    mac: 'https://s3.amazonaws.com/release.zbay.app/Zbay-1.0.63-dev-mac-2.dmg'
  };
